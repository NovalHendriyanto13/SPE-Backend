 <header class="navbar navbar-header navbar-header-fixed">
  ...
  <div class="navbar-brand">
    <a href="{{url('/')}}" class="df-logo">SP<span>e</span></a>
  </div><!-- navbar-brand -->
        ...
        <div class="navbar-menu-sub">
          <div class="d-lg-flex">
            <ul>
              ...
              <li class="nav-sub-item"><a href="{{URL::to('user')}}" class="nav-sub-link"><i data-feather="log-in"></i> Users</a></li>
              <li class="nav-sub-item"><a href="{{URL::to('discount')}}" class="nav-sub-link"><i data-feather="user-plus"></i> Discount</a></li>
              <li class="nav-sub-item"><a href="{{URL::to('customer')}}" class="nav-sub-link"><i data-feather="user-plus"></i> Customer</a></li>
              <li class="nav-label">Transaction</li>
              <li class="nav-sub-item"><a href="{{URL::to('transaction')}}" class="nav-sub-link"><i data-feather="log-in"></i> Transaction</a></li>
              <li class="nav-label">Logs</li>
              <li class="nav-sub-item"><a href="{{URL::to('log')}}" class="nav-sub-link"><i data-feather="log-in"></i> API</a></li>
            </ul>
          </div>
        </div><!-- nav-sub -->
      </li>
